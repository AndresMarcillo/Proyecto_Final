...
public class Serie {
    ...
    public Serie(int id, String title, String genre, String creator, int duration, short year, boolean viewed, int timeViewed, int sessionQuantity, Chapter chapters) {
        this.id = id;
        this.title = title;
        this.genre = genre;
